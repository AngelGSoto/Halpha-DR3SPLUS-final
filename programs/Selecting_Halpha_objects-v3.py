...
cx, cy = colour(df, "R_petro", "I_petro", "R_petro", "F660_petro")
...
data = pd.concat([df["RA"], df["DEC"], df["FWHM"], df["R_petro"], colum1, colum2], axis=1)
...
ecx, ecy = errormag(df, "e_R_petro", "e_I_petro", "e_R_petro", "e_F660_petro")
