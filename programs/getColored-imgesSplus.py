...
# Converting number of pixel in arcse
rad_ang = (0.55 * rad)/ 3.

ax1.add_scalebar(rad_ang/3600)
ax1.scalebar.set_label('~'+str(format(rad_ang, '.0f')) + ' arcsec')
ax1.scalebar.set(color='yellow', linewidth=6, alpha=0.9)
...
# Deleting files
os.remove('{}_{}-{}_{}_r.fz'.format(Name, ra, dec, rad))
print("FZ File Removed!")

os.remove('{}_{}-{}_{}_r.fits'.format(Name, ra, dec, rad))
